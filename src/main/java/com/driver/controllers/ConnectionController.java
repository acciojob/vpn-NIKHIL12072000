...
public class ConnectionController {
    ...
    public ResponseEntity<Void> communicate(@RequestParam int senderId, @RequestParam int receiverId) throws Exception{
        ...
        //Else his current country is his original country.

        //The sender is initially not connected to any vpn.
        //If the sender's original country does not match receiver's current country,we need to connect the sender to a suitable vpn. If there are multiple options, connect using the service provider having smallest id
        //Else we do not need to do anything as they can communicate. Return the sender as it is.
